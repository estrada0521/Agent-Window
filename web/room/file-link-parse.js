    ...
    const pathFromLocalHref = (href) => {
      ...
      try {
        ...
        if (url.origin === window.location.origin && ((ROOM_BASE_PATH && (url.pathname === `${ROOM_BASE_PATH}/file-raw` || url.pathname === `${ROOM_BASE_PATH}/file-view`)) || url.pathname === "/file-raw" || url.pathname === "/file-view")) {
