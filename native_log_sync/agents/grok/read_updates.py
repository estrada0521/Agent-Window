...
def _sync_grok_chat_history(runtime, agent: str, history_path: str) -> bool:
    ...
    start = read_offset_start(runtime._native_log_read_offsets, history_path, file_size)
    if start >= file_size:
        return False
...
def sync_grok_native_log(
    ...
    *,
    ...
    if start_at_end:
        ...
        advance_read_offset(runtime._native_log_read_offsets, history_path, history_size)
        return
    start = read_offset_start(runtime._native_log_read_offsets, updates_path, file_size)
