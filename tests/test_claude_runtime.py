...
class ClaudeRuntimeTests(unittest.TestCase):
    ...
    def test_unknown_tools_have_visible_fallback(self) -> None:
        self.assertTrue(runtime_tool_events("FutureTool", {"value": 1})[0]["keyword"])
        self.assertTrue(runtime_tool_events("FutureTool", "unknown payload")[0]["keyword"])
        self.assertTrue(runtime_tool_events("mcp__playwright__browser_hover", {"element": "Menu"})[0]["keyword"])
